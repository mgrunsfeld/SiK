...
; This file was generated Mon Jul 23 11:34:31 2018
;--------------------------------------------------------
	.module printfl
...
_printf_start_capture_PARM_2:
	.ds 1
_printf_start_capture_buf_1_130:
	.ds 2
;--------------------------------------------------------
...
;------------------------------------------------------------
;	radio/printfl.c:65: output_char(register char c) __nonbanked
;	-----------------------------------------
...
;buf                       Allocated with name '_printf_start_capture_buf_1_130'
;------------------------------------------------------------
;	radio/printfl.c:78: printf_start_capture(__xdata uint8_t *buf, uint8_t size) __nonbanked
;	-----------------------------------------
...
_printf_start_capture:
	mov	r7,dph
	mov	a,dpl
	mov	dptr,#_printf_start_capture_buf_1_130
	movx	@dptr,a
	mov	a,r7
	inc	dptr
	movx	@dptr,a
...
;------------------------------------------------------------
;	radio/printfl.c:88: printf_end_capture(void) __nonbanked
;	-----------------------------------------
...
;buffer                    Allocated with name '_vprintfl_buffer_4_149'
;------------------------------------------------------------
;	radio/printfl.c:95: vprintfl(const char * fmt, va_list ap) __reentrant __nonbanked
;	-----------------------------------------
;	 function vprintfl
;	-----------------------------------------
_vprintfl:
...
;------------------------------------------------------------
;	radio/printfl.c:186: printfl(const char *fmt, ...) __reentrant __nonbanked
;	-----------------------------------------
;	 function printfl
;	-----------------------------------------
_printfl:
